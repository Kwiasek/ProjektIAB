...
<form action="/auth/login" method="post" class="max-w-md mx-auto bg-white p-6 rounded-lg shadow">
    ...
    <div class="mb-4">
        <label for="login" class="block text-gray-700 mb-1">Login</label>
        <input type="text" name="login" id="login" required class="w-full ring ring-blue-500 active:ring-blue-600 active:outline-blue-600 rounded px-3 py-2" />
    </div>

    <div class="mb-4">
        <label for="password" class="block text-gray-700 mb-1">Hasło</label>
